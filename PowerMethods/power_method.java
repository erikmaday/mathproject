...
//            MatrixGroup matrixGroup = new
//                    MatrixGroup(generateRandomMatrix(-2, 2));
//
//            double[] powerMethod =
//                    powerMethod(matrixGroup.getMatrix(), ACCURACY);
//            double[] inversePowerMethod =
//                    inversePowerMethod(matrixGroup.getMatrix(), ACCURACY);
//
...
//            matrixGroup.setInversePowerMethodIterations((int)
//                    inversePowerMethod[1]);
//
...
//
//    /**
//     * Generate a random 2x2 matrix with
...
//        //Generate a 2×2 matrix with random
//        // components evenly distributed in an interval [a,b]
...
//                matrix[r][c] = rand.nextDouble() * (upperBound
...
//        double eigenvalue = 0;
//
//        while (relativeError * 100 > (0.5 * Math.pow(10, 2
//                - desiredAccuracy)) && iterations < MAX_ITERATIONS) {
//            //Approximate
//            approximation = new Matrix(LinearAlgebra.multiplyMatrix(
//                    matrix.toArray(), approximation.toArray()));
//            //Use's the Rayleigh Equation to solve for the eigenvalue
//            eigenvalue = rayleighEquation(matrix, approximation);
//            //Calculate the accuracy
//            relativeError = Math.abs((eigenvalue
...
//     */
//    public static double[] inversePowerMethod(
//            Matrix matrix, int desiredAccuracy) {
//        Matrix approximation = new Matrix(new double[][]{{1}, {1}});
//        int iterations = 0;
//
//        double relativeError = Double.MAX_VALUE;
...
//                - desiredAccuracy)) && iterations < MAX_ITERATIONS) {
//            //Approximate!
//            approximation = LinearAlgebra.multiplyMatrix(
...
//
//    /**
//     * Solve for the eigenvalue given the matrix
...
//        Matrix rayleighNominator =
//                (matrix.times(eigenvector)).transpose().times(eigenvector);
//        Matrix rayleighDenominator = eigenvector.transpose().times(eigenvector);
//
//        return rayleighNominator.getArray()[0][0]
//                / rayleighDenominator.getArray()[0][0];
//    }
//}